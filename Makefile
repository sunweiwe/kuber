...
generate: controller-gen ## Generate code containing DeepCopy, DeepCopyInto, and DeepCopyObject method implementations.
	# $(CONTROLLER_GEN) paths="./pkg/api/plugin/..." crd  output:crd:artifacts:config=deploy/plugins/kuber-installer/crds
	$(CONTROLLER_GEN) paths="./pkg/api/kuber/..."    crd  output:crd:artifacts:config=deploy/plugins/kuber-local/crds
